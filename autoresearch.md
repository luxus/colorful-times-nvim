...
- Benchmark integrity check pending: `autoresearch.checks.sh` now also verifies `bench/minimal-switcher.lua` stays independent of `colorful-times` modules/references.
