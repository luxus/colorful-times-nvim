...
- Benchmark diagnostics pending: add `command_p25_us`, `command_p75_us`, and `command_iqr_us` so future command registration tweaks are judged against measured command noise.
