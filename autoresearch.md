...
- Benchmark diagnostics pending: add per-scenario apply delta metrics (`apply_delta_empty_us`, `apply_delta_two_entry_us`, `apply_delta_disabled_us`, `apply_delta_hourly_us`) to complement startup scenario metrics without changing the primary aggregate metric.
