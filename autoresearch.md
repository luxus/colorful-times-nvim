...
- Benchmark diagnostics pending: reuse existing paired startup/apply samples to compute per-scenario diagnostics instead of running separate scenario passes, preserving metric names while reducing benchmark runtime/duplication.
