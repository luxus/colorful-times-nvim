...
- Benchmark diagnostics pending: add per-scenario cold first-apply deltas to show whether the first-switch gap is broad or concentrated in the hourly schedule scenario.
