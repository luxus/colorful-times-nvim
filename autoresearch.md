...
- Experiment pending: split runtime schedule parse/lookup helpers into `schedule_runtime.lua` and have `core.lua` load that smaller runtime module on first apply while `schedule.lua` keeps the public validation wrapper.
