...
- Experiment pending: expose `validate_entry` from `schedule_runtime.lua` and re-export it from `schedule.lua` to remove duplicated validation logic introduced by the runtime split.
